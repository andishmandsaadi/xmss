...
int xmss_keypair(unsigned char *hors_sk, unsigned char *pk, unsigned char *sk, const uint32_t oid)
{
    xmss_params params;
    unsigned int i;
    ...
    return xmss_core_keypair(&params, hors_sk + XMSS_OID_LEN, pk + XMSS_OID_LEN, sk + XMSS_OID_LEN);
}

int xmss_sign(unsigned char *hors_sk, unsigned char *sk,
              ...
              const unsigned char *m, unsigned long long mlen)
{
    ...
    return xmss_core_sign(&params, hors_sk + XMSS_OID_LEN, sk + XMSS_OID_LEN, sm, smlen, m, mlen);
}
...
int xmssmt_keypair(unsigned char *hors_sk, unsigned char *pk, unsigned char *sk, const uint32_t oid)
{
    xmss_params params;
    unsigned int i;
    ...
    return xmssmt_core_keypair(&params, hors_sk + XMSS_OID_LEN, pk + XMSS_OID_LEN, sk + XMSS_OID_LEN);
}

int xmssmt_sign(unsigned char *hors_sk, unsigned char *sk,
                unsigned char *sm, unsigned long long *smlen,
                const unsigned char *m, unsigned long long mlen)
{
    xmss_params params;
    ...
    return xmssmt_core_sign(&params, hors_sk + XMSS_OID_LEN, sk + XMSS_OID_LEN, sm, smlen, m, mlen);
}
