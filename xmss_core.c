...
static void treehash(const xmss_params *params,
                     ...
                     uint32_t leaf_idx, const uint32_t subtree_addr[9])
{
                      ...
                      unsigned char *hors_sk, unsigned char *pk, unsigned char *sk)
{
    ...
    return xmssmt_core_keypair(params, hors_sk, pk, sk);
}
                   ...
                   const unsigned char *m, unsigned long long mlen)
{
    ...
    return xmssmt_core_sign(params, hors_sk, sk, sm, smlen, m, mlen);
}
                        ...
                        unsigned char *hors_sk, unsigned char *pk, unsigned char *sk)
{
    ...
    xmssmt_core_seed_keypair(params, hors_sk, pk, sk, seed);
                     ...
                     const unsigned char *m, unsigned long long mlen)
{
    ...
    set_type(hors_ots_addr, XMSS_ADDR_TYPE_OTS);
    set_type(ots_addr, XMSS_ADDR_TYPE_OTS);
    ...
    *smlen = params->sig_bytes + mlen;
    ...
    idx = mhash[0] + mhash[22] + mhash[5] + mhash[9];
    ...
    for (i = 0; i < params->d; i++) {
        ...
        hors_sign(params, sm, mhash, hors_sk, sk_seed, hors_ots_addr);
